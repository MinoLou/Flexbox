...
//Rutas para el store de trabajos realizados
//Rutas para el store de trabajos realizados
Route::post('/trabajo/create', 'TrabajoController@store');
Route::get('/trabajo/{id}', 'TrabajoController@show')->name('show');
Route::delete('/trabajo/{id}', 'TrabajoController@destroy')->name('destroy');
Route::get('/trabajo/edit/{id}', 'TrabajoController@edit')->name('edit');
Route::put('/trabajo/edit/{id}', 'TrabajoController@update')->name('update');
